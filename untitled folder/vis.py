...
df=pd.read_csv("D:/EIRES.txt",sep="\t")
df=df[df.branch == 'EI']
...
plt1.savefig("D:/pieEC1.png",dpi=1000)
plt.close()
'''
...
plt.show()
plt.draw()
plt1.savefig("D:/pltEI-SGPA.png",dpi=500)
plt.close()
#plt.show()
'''
...
plt.show()
plt.draw()
plt1.savefig("D:/pltEI-CGPA.png",dpi=300)
plt.close()
#plt.show()
'''
...
plt.show()
plt.draw()
plt1.savefig("D:/pltEIactoname-SGPA.png",dpi=300)
plt.close()
#plt.show()
'''